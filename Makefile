...
LDLIBS = -lbitpack -lum-dis -lcii -lnetpbm -lcii40 -lm -lrt
...
um: um.o readUM.o execute.o registers.o memory.o instructions.o
	$(CC) $(LDFLAGS) $(IFLAGS) $^ -o $@ $(LDLIBS)
	
unit_test: unit_test.o registers.o memory.o
	$(CC) $(LDFLAGS) $(IFLAGS) $^ -o $@ $(LDLIBS)
